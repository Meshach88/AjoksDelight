...
const Vision = () => {
  return (
    <div>
      <section className="flex flex-col-reverse md:flex-row justify-center max-w-5xl items-center mx-auto mt-5 md:mt-20">
        <article className="flex flex-col gap-4 md:w-1/2 justify-center items-center text-center m-5">
          <div className="bg-slate-300 rounded-lg p-5 m-5 transition-all duration-500 hover:shadow-lg">
          ...
          <div className="bg-slate-300 rounded-lg p-5 m-5 hover:shadow-lg transition-all duration-500">
